    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function(Theme $theme)
        {
            ...
            $theme->asset()->container('footer')->usePath()->add('localtion-search', 'js/localtion-search.js', [], [], $version);

			if(!empty(request()->segments()[0]) && request()->segments()[0] == 'calculator')
			{
				$theme->asset()->container('header')->usePath()->add('calculator', 'js/calculator.js');
				$theme->asset()->container('header')->add('morris.min', 'vendor/core/core/base/libraries/morris/morris.min.js');
				$theme->asset()->container('header')->add('raphael-min', 'vendor/core/core/base/libraries/raphael-min.js');
				$theme->asset()->add('morris-css', 'vendor/core/core/base/libraries/morris/morris.css');
			}
