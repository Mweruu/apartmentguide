...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    homeTypeSearch.find('a').on('click', function () {
      ...
      /* Show Advance Search Open only in Desktop : Prakash */
      if (window.innerWidth > 991) {
        $(".advanced-search-toggler").trigger('click');
      }
    });
    var timeout = null;
    ...
    //Default First Tab Called : Prakash
    $('#hometypesearch a.active').trigger('click');
  });
})(jQuery);
/******/ })()
;