var EMICalculator = function () {
	...
	var drawChart = (EMIResult) => {
		$("#payment_graph").empty();
		Morris.Donut({
			element: 'payment_graph',
			data: [
				{label: "Total Interest", value: EMIResult.Interest},
				{label: "Principal Amount", value: EMIResult.Principal}
			],
	...
	var num2money = function(yourNumber) {
	...
	var money2num = function(nameStr) {
