    ...
    public function buildForm()
    {
        Assets::addStyles(['datetimepicker'])
            ...
            ->addScriptsDirectly([
			    ...
			    'themes/flex-home/js/availability.js',
            ])
        ...
        if ($this->getModel()) {
            $selectedAvailabilities = $this->getModel()->availabilities()->get();
        }		
        ...
        $this
			...
			->add('auto_renew', 'html', [
				'html' => '<div class="alert alert-secondary" role="alert">Your listing will expire after '.RealEstateHelper::propertyExpiredDays().' days of the creation date.</div>',
            ])
            ->addMetaBoxes([
                'features'   => [
				...
				'availability'   => [
                    'title'    => trans('plugins/real-estate::property.form.availability'),
                    'content'  => view('plugins/real-estate::partials.form-availability',
                        compact('selectedAvailabilities'))->render(),
                    'priority' => 2,
                ],
            ])
