    ...
    <!-- Right Side Of Navbar -->
      <ul class="navbar-nav ml-auto my-2">
        ...
        @else
          ...
          <li>
              <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.properties.index') }}" title="My Properties">
                  <i class="far fa-newspaper mr1"></i>My Properties
              </a>
          </li>

              @if (auth('account')->user()->canPost())
              <li>
                  <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.properties.create') }}" title="Add Properties">
                      <i class="far fa-edit mr1"></i>Add Properties 
                  </a>
              </li>
          @endif
          <li>
